...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 text-white shadow-md transition-all duration-300 font-sans ${
        ...
        <nav className="hidden md:flex gap-8 items-center">
          {navLinks.map(({ label, href }) => (
            <a
              key={label}
              href={href}
              className="relative text-xl font-medium text-white hover:text-black hover:bg-white px-4 py-1 rounded-lg transition duration-300"
            >
              {label}
