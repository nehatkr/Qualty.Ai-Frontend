...
export default function HeroSection() {
  ...
  return (
    <section className="bg-black text-white relative overflow-hidden" id="home">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-35 flex flex-col lg:flex-row items-center justify-between gap-12">
        <div className="max-w-xl py-25">
          ...
          <p className="text-white mb-6 text-md font-light">
          ...
          <div className="flex gap-4 flex-wrap items-center">
            ...
            <button onClick={()=>navigate("")} className="px-3 py-2 sm:px-5 sm:py-3 text-sm sm:text-md border cursor-pointer border-white text-white rounded hover:bg-white hover:text-black hover:font-semibold transition flex items-center gap-2">
              <Play size={20} />
              Watch Demo
            </button>
            </Link>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-12 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {stats.map((stat, index) => (
          <div
            key={index}
            className=" border border-white rounded-xl p-6 text-center shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
          >
