      ...
      <section className="py-16 px-6 sm:px-12 lg:px-20 mt-20">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-300 max-w-3xl mx-auto mb-12">
            We offer a complete suite of quality inspection services designed to
            ensure your cargo meets the highest standards and regulatory
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {featuredServices.map((service, index) => (
              ...
              >
                ...
                <ul className="list-disc list-inside text-gray-400 space-y-1 mb-4 pl-2">
                  {service.features.map((feature, idx) => (
          ...
          <div className="mt-20 text-center">
            <div className=" text-white p-8 max-w-3xl mx-auto shadow-[inset_0_0_0.5px_rgba(255,255,255,0.1)] border border-gray-700 backdrop-blur-md transition-all duration-500 hover:shadow-[0_0_40px_rgba(255,255,255,0.2)]">
              ...
              <p className="text-gray-300 mb-6 text-sm sm:text-base leading-relaxed">
                Raise your inspection query with a budget and get multiple
                quotes from verified global inspectors. Choose the best for your
                cargo inspection needs.
              </p>
              <button
