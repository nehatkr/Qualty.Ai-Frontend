    ...
    {loading ? (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-6xl mx-auto animate-fade-in">
        {bids.map((bid) => (
          <div
            key={bid._id}
            className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-300 transform hover:scale-[1.02]"
          >
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-lg font-bold text-green-600">{bid.enquiry.location}</h3>
            ...
            <p className="text-sm text-gray-700 mb-1">
              📦 Commodity: <span className="text-black">{bid.enquiry.commodity}</span>
            </p>
            <p className="text-sm text-gray-700 mb-1">
              🧪 Volume: <span className="text-black">{bid.enquiry.volume}</span>
            </p>
            <p className="text-sm text-gray-700 mb-1">
              📞 Contact: <span className="text-black">{bid.enquiry.contact}</span>
            </p>
            <p className="text-sm text-gray-700 mb-1">
              📌 Status: <span className="text-blue-600">{bid.enquiry.status}</span>
            </p>
