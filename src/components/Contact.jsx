       ...
       <div className="pt-16 bg-black text-white px-8 md:px-16 pb-8 md:pb-12">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 mt-4 max-w-3xl mx-auto">
            Contact our experts today to discuss your quality inspection needs and discover
            how Quality.AI can connect you with the best global inspectors for your cargo.
          </p>
        </div>
      </div>

    <div className="min-h-screen bg-black text-white flex flex-col md:flex-row p-8 md:p-16">
      ...
      <div className="w-full md:w-2/3 bg-neutral-900 rounded-xl p-8 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block text-sm mb-1">Location of Inspection *</label>
              <input
                type="text"
                name="location"
            ...
            <div>
              <label className="block text-sm mb-1">Are you an Importer or Exporter? *</label>
              <select
                name="role"
                value={formData.role}
                onChange={handleChange}
